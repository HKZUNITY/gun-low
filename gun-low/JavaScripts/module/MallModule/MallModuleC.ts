...
export default class MallModuleC extends ModuleC<MallModuleS, MallData> {
    ...
    private async initNpc(): Promise<void> {
        this.maleNpc = await mw.GameObject.asyncFindGameObjectById(`19241408`) as mw.Character;
        this.feMaleNpc = await mw.GameObject.asyncFindGameObjectById(`18274918`) as mw.Character;
        this.transitionNpc = await mw.GameObject.asyncFindGameObjectById(`2FACBE6E`) as mw.Character;
        this.copyNpc = await mw.GameObject.asyncFindGameObjectById(`184B0D19`) as mw.Character;
        await this.localPlayer.character.asyncReady();
        let somatotype = this.localPlayer.character.description.advance.base.characterSetting.somatotype;
